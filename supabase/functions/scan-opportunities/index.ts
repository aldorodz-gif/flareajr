...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = [
      ...
      "SEARCH MINDSET: Search for new business movements in these markets that could create 30+ day corporate housing demand. Prioritize expansions, relocations, contract awards, phased construction, project mobilizations, training cohorts, temporary workforce movements, and large group activity likely to require extended stays. Ignore generic hiring news and short hotel-only event traffic.",
      ...
      "Example: if Boeing wins a $500M Air Force contract in Huntsville, return the SMB engineering firms, subcontractors, IT integrators, and construction subs (10-1000 employees) Boeing hires — not Boeing or the Air Force.",
      "Example: if a hospital builds a new wing, return the mechanical contractor, electrical sub, medical equipment installer, or commissioning firm — not the hospital.",
      "Example: if a city wins a federal grant, return the engineering consultancy, environmental firm, or construction manager doing the work — not the city.",
      "Always name the SMB and explain in 'why_it_matters' which larger project/client is driving their 30+ day travel/housing need.",
      "Every opportunity must be a real SMB (10-1000 employees) sending people on-site for 30+ days.",
      "NEVER include other corporate housing providers (Synergy, Churchill, Mint House, Oakwood, AKA, Sonder, etc.).",
      "RETURN AT LEAST 10 OPPORTUNITIES per scan. Keep each description tight and scannable — no fluff.",
      ...
      "Set priority High / Medium / Low based on how likely the 30+ day need is.",
      "Suggest 3-5 contact titles at the SMB (Project Manager, Field Ops, Travel Coordinator, HR/Talent, Program Manager — avoid C-suite).",
