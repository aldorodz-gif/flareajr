        ...
        <div className="flex gap-2">
          {presets.map((p, i) => (
            <div
              ...
              style={{
                background: i === active ? 'linear-gradient(135deg, #DC2626, #db2777)' : 'rgba(255,255,255,.06)',
        ...
        <div className="flex flex-wrap gap-1.5">
          {verticals.map((v, i) => (
            <div
              ...
              style={{
                background: i === active ? 'linear-gradient(135deg, #DC2626, #DC2626)' : 'rgba(255,255,255,.05)',
        ...
        {signals.map((s, i) => (
          <div
            ...
            style={{
              ...
              color: i === active ? '#DC2626' : 'rgba(255,255,255,.5)',
              borderLeft: i === active ? '2px solid #DC2626' : '2px solid transparent',
            }}
          >
            <span>{s.icon}</span>
            {s.label}
      ...
      <div className="h-[140px] rounded-md p-3 flex flex-col justify-center gap-3" style={{ background: '#0a0a14', border: '1px solid rgba(251,146,60,.25)' }}>
        ...
        <div className="flex justify-center">
          <div
            ...
            style={{
              background: ready ? 'linear-gradient(135deg, #DC2626, #db2777)' : 'rgba(255,255,255,.08)',
        ...
        <div className="flex gap-1.5 justify-center">
          {days.map((d, i) => (
            <div
              ...
              style={{
                background: i <= active ? 'linear-gradient(135deg, #DC2626, #db2777)' : 'rgba(255,255,255,.05)',
