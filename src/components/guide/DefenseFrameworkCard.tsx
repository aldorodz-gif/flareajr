  ...
  },
  {
    ...
    body: (
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div className="p-3 rounded-lg" style={{ background: '#FAF7F2', border: '1px solid rgba(168,85,247,.15)' }}>
          <p className="text-[11px] font-bold uppercase tracking-wider mb-2" style={{ color: '#a855f7' }}>Northern Virginia</p>
        ...
        <div className="p-3 rounded-lg" style={{ background: '#FAF7F2', border: '1px solid rgba(45,212,191,.18)' }}>
      ...
      <div className="flex flex-wrap gap-1.5">
        {[
          ...
          <span key={v} className="text-[11px] px-2.5 py-1 rounded-full font-medium"
            style={{ background: 'rgba(236,72,153,.08)', color: '#ec4899', border: '1px solid rgba(236,72,153,.2)' }}>
            {v}
          </span>
        ))}
      </div>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p className="text-[11px] font-bold uppercase tracking-wider mb-2 mt-3" style={{ color: '#ec4899' }}>Anchor ecosystems</p>
        <div className="flex flex-wrap gap-1.5">
    ...
    body: (
      <>
        <div className="p-3 rounded-lg mb-3" style={{ background: 'rgba(168,85,247,.08)', border: '1px solid rgba(168,85,247,.2)' }}>
          <p className="text-[11px] font-bold uppercase tracking-wider mb-1" style={{ color: '#a855f7' }}>Positioning Statement</p>
        ...
        <p className="text-[11px] font-bold uppercase tracking-wider mb-1.5" style={{ color: '#ec4899' }}>Do NOT position as apartment providers</p>
        ...
        <p className="text-[11px] font-bold uppercase tracking-wider mb-1.5 mt-3" style={{ color: '#ec4899' }}>Core messaging angles</p>
  ...
  },
  {
    ...
    body: (
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        <div>
          <p className="text-[11px] font-bold uppercase tracking-wider mb-1.5" style={{ color: '#a855f7' }}>Northern Virginia</p>
          <ul className="text-[12px] text-foreground space-y-1">
        ...
        {[
          ...
          <li key={q} className="flex gap-2.5">
            <span className="text-[11px] font-bold rounded-full w-5 h-5 flex items-center justify-center flex-shrink-0 mt-0.5"
              style={{ background: 'rgba(168,85,247,.12)', color: '#a855f7' }}>{i + 1}</span>
    ...
    body: (
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div className="p-3 rounded-lg" style={{ background: 'rgba(236,72,153,.06)', border: '1px solid rgba(236,72,153,.2)' }}>
          <p className="text-[11px] font-bold uppercase tracking-wider mb-1.5" style={{ color: '#ec4899' }}>✗ Avoid</p>
          <ul className="text-[12px] text-foreground space-y-0.5">
          ...
          <div className="flex flex-wrap gap-1 p-3 border-b" style={{ borderColor: 'rgba(168,85,247,.1)' }}>
            {SECTIONS.map(s => (
              <button key={s.id} onClick={() => setActive(s.id)}
                ...
                style={{
                  background: active === s.id ? 'linear-gradient(135deg, #a855f7, #ec4899)' : 'rgba(168,85,247,.06)',
