      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8 animate-slide-up">
          <div className="inline-flex items-center gap-2 bg-primary/10 text-primary px-4 py-2 rounded-full text-sm font-medium mb-4">
            ...
            BDR Execution System
          </div>
          <h1 className="text-3xl font-bold text-foreground">Flare</h1>
          <p className="text-muted-foreground mt-2">Your daily outbound execution engine</p>
        </div>

        <div className="bg-card rounded-2xl shadow-lg border p-8 animate-slide-up" style={{ animationDelay: '0.1s' }}>
          ...
          <Button variant="outline" onClick={handleGoogleSignIn} className="w-full h-11 rounded-xl">
